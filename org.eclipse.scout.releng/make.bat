...
set buildFlags=-DskipClean=false -DskipSign=true -DskipDownloadRepository=false -DskipUpload=false -DbuildType=N -DscoutDownloadLocation=D:/Temp/max24h/eclipseBuild/download
