...
set nighltyRepoVar=-DnightlyRepository=E:\workspaces\scout.build\p2Workspace\org.eclipse.scout.sdk.releng\final\nightlyP2Repo
...
set logfile=org.eclipse.scout.sdk.releng/scoutBuild.log

PATH=%JAVA_HOME%\bin;%ANT_HOME%\bin;%PATH%


call ant -f org.eclipse.scout.sdk.releng/buildFiles/build.xml %buildOpts%  %nighltyRepoVar% -DskipSign=true %* build 
